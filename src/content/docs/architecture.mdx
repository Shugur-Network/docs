...
graph TB
    ...
    subgraph "Shugur Distributed Cluster"
        subgraph "Relay Nodes"
            N1[Node 1<br/>Gateway]
            N2[Node 2<br/>Gateway]
            N3[Node 3<br/>Gateway]
        end
...
|------------------|------------------|
| Client manages multiple connections | Single connection to cluster |
| Manual failover logic required | Automatic failover |
| Data scattered across relays | Unified data across cluster |
| Complex relay discovery | Simple gateway discovery |
