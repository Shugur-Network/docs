...
Decentralized static website hosting on Nostr:

- **NIP-YY**: Event kinds for web pages (40000-40003, 34235, 34236)
- **NIP-ZZ**: DNS bootstrap protocol for domain-to-pubkey resolution
...
- Parameterized replaceable events for dynamic updates
- Multi-relay redundancy for availability
- DNS TXT record bootstrap at `_nweb.<domain>`
...
| 34235 | NIP-YY | Page Manifest | Full support |
| 34236 | NIP-YY | Site Index | Full support |
| 34550 | NIP-72 | Community | Full support |
| 40000 | NIP-YY | HTML Content | Full support |
| 40001 | NIP-YY | CSS Stylesheet | Full support |
| 40002 | NIP-YY | JavaScript | Full support |
| 40003 | NIP-YY | Component | Full support |
