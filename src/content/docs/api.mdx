---
title: API Reference
description: Complete API documentation for Shugur Relay WebSocket and HTTP endpoints. Learn how to interact with the Nostr protocol and management APIs.
---
