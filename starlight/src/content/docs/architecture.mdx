...
- Installation Guide: Now that you understand the architecture, proceed to the installation guide to deploy the relay.
- Nostr Concepts: Learn more about the Nostr protocol itself.
